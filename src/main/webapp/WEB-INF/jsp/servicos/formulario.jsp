...
<tags:layout>
    ...
    <jsp:attribute name="rodape">
        ...
        <script>
            ...
            $('#assumirServico').change(function () {
                if(this.checked){
                    $('#btnAdicionarTarefa').removeAttr("disabled");
                    console.log($('#container-inputs-tarefa').children().length);
...
//            if($('#tecnico-servico').val() != "") {
//                $('#btnAdicionarTarefa').removeAttr("disabled");
//                $('#btnAdicionarTarefa').attr("data-target","#myModal");
//            } else {
//                $('#btnAdicionarTarefa').attr('disabled','disabled');
//                $('#btnAdicionarTarefa').attr('data-target','#');
//            }
        </script>
    </jsp:attribute>
        ...
        <div class="panel painel-cadastro-sisint">
            <form id="form-servico-tarefa" action="${linkTo[ServicosController].salvar}" method="post">
                ...
                <div class="panel-body">
                    ...
                    <div id="cadastro-servico">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                            <label>Assumir serviço:
                                <div style="margin-left: 16px; float: right;">
                                    <input id="assumirServico" type="checkbox" checked name="servico.assumirServico"/>
                                </div>
                            </label>
                            </div>
                ...
                <div class="panel-footer" align="right">
                    <button id="btn-salvar-servico" class="btn btn-primary" type="submit">Salvar</button>
                </div>
            </form>
            <!-- Modal -->
